package com.zhang.chat.corelib.recycleview;
...
public class IRecyclerView extends RecyclerView {
    ...
    public void setRefreshing(boolean refreshing) {
        if (mStatus == STATUS_DEFAULT && refreshing) {
            ...
            this.mIsAutoRefreshing = false;
            AppLog.e(TAG + "isRefresh = " + refreshing + " current status = " + mStatus);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (index < 0) {
                    AppLog.e(TAG + "Error processing scroll; pointer index for id " + index + " not found. Did any MotionEvents get skipped?");
                    return false;
                }
                ...
                if (DEBUG) {
                    AppLog.i(TAG + "triggerCondition = " + triggerCondition + "; mStatus = " + mStatus + "; dy = " + dy);
                }
                if (triggerCondition) {
    ...
    Animator.AnimatorListener mAnimationListener = new SimpleAnimatorListener() {
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            if (DEBUG) {
                AppLog.i(TAG + "onAnimationEnd " + getStatusLog(lastStatus) + " -> " + getStatusLog(mStatus) + " ;refresh view height:" + mRefreshHeaderContainer.getMeasuredHeight());
            }
        }
    };
    ...
    private void printStatusLog() {
        AppLog.i(TAG + getStatusLog(mStatus));
    }
