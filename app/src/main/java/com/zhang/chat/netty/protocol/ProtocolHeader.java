package com.zhang.chat.netty.protocol;
...
public class ProtocolHeader {
    ...
    /** type: 0x11 ~ 0x23 =========================================================================================== */
    public static final byte Add_New_Friend_Info                 = 0x11;    // 新朋友消息
    public static final byte Token              = 0x12;    // Token过期
    ...
    public static final byte PERSONAL_MESSAGE_LIST         = 0x16;    //
    ...
    public static final byte USER_MESSAGE             = 0x23;    // 用户信息
