...
import com.zhang.chat.corelib.bean.CustomTabEntity;
import com.zhang.chat.corelib.bean.TabEntity;
import com.zhang.chat.corelib.flyn.Eyes;
import com.zhang.chat.corelib.listener.OnTabSelectListener;
import com.zhang.chat.corelib.utils.UnreadMsgUtils;
import com.zhang.chat.corelib.utils.ViewFindUtils;
import com.zhang.chat.corelib.widget.CommonTabLayout;
import com.zhang.chat.corelib.widget.MsgView;
...
public abstract class MainBaseActivity<T extends BasePresenter, M extends BaseModel> extends AppCompatActivity {
    ...
    private void setStateBar() {
        Eyes.setStatusBarLightMode(this,getResources().getColor(R.color.Gray_F5F5F5));
    }
    ...
    private void initTabEntities() {
        ...
        mViewPager.setAdapter(new MainBaseActivity.CommonPagerAdapter(getSupportFragmentManager()));
        //设置监听事件
